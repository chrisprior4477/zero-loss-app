...
try {
  ...
  # Keep Windows PowerShell 5.1 from serializing Get-Content metadata as an object.
  $auditSql = [string](Get-Content -Raw -LiteralPath (Join-Path $auditRoot 'supabase/tests/inspection/wallet_integrity.sql'))
