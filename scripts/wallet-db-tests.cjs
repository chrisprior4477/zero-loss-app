...
const tests = ['wallet_account_isolation_test.sql','verified_demo_funding_test.sql',
  ...
  'preview_availability_test.sql','account_lifecycle_test.sql','demo_credit_card_test.sql','funding_authorization_test.sql','entry_request_undo_test.sql','entry_recovery_test.sql','support_cases_test.sql'];
