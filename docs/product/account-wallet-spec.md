...
A verified winner may designate another eligible person as the prize recipient after the result is confirmed and before digital fulfillment is issued. The wallet must record this as a recipient designation on the winning fulfillment—not as a transfer of the entry, win record, wallet balance, or completion option. The original account remains the winner of record. Entries and non-selected completion options may never be gifted or transferred. Recipient designation remains inactive until counsel-approved eligibility, identity, tax, fraud, sanctions, territorial, age, and provider controls are defined.

A verified winner may designate another eligible person to receive the awarded prize or retailer-specific digital gift card after the win is confirmed and before fulfillment is issued. This does not transfer the winning entry, account ownership, wallet value, or any non-selected completion option; the original winner remains the winner of record. The wallet should record the recipient designation as an audited fulfillment instruction. Identity, eligibility, tax, fraud, territorial, retailer, and provider checks remain required, and production activation is deferred pending counsel and provider approval.
