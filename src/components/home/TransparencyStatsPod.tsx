...
export function TransparencyStatsPod() {
  return (
    <section aria-labelledby="transparency-stats-title" className="relative hidden w-full overflow-hidden border-t border-cyan-300/15 bg-[linear-gradient(180deg,#031b38_0%,#000f25_100%)] lg:block">
      <div className="relative mx-auto max-w-[1600px] px-[clamp(3rem,6vw,7rem)] py-6">
        ...
        <div className="relative grid grid-cols-[1.05fr_1.35fr] gap-6">
          ...
          <div className="min-w-0 border-l border-white/10 py-1 pl-6">
