...
export function DollarWall() {
  ...
  const bundleControls = (mobile = false) => <>
    ...
    {picks.length > 0 && <button type="button" onClick={reset} className={`${mobile ? "order-3" : ""} mt-3 w-full rounded-md border border-white/20 px-2 py-2 text-[10px] font-bold text-white/70 hover:bg-white/10`}>Clear all</button>}
