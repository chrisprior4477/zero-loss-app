      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,.85fr)] lg:items-start">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            <p className="mt-3 text-sm text-white/65">{product.brand} · Supplied through {product.retailer}</p>
            ...
            <DemoParticipationPanel entryPrice={product.entryPrice} sold={product.sold} capacity={product.capacity} />
          </div>
        </div>
        ...
        <section className="mt-10 grid gap-4 rounded-3xl border border-white/12 bg-[#001b3d] p-6 sm:grid-cols-3 sm:p-8">
          ...
          <div><strong className="text-cyan-300">No hidden checkout</strong><p className="mt-2 text-sm leading-6 text-white/65">This prototype clearly stops before accepting payment or creating an entry.</p></div>
        </section>
      </div>
    </main>
  );
